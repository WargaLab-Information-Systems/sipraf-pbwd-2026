            ...
            <div class="max-w-6xl mx-auto bg-white rounded-lg shadow-md p-6 border border-gray-200">
                ...
                <div class="flex justify-between items-center border-b border-gray-200 pb-4 mb-6">
                    ...
                    <div class="flex gap-3 print:hidden">
                        <a href="from.php" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded shadow text-sm font-semibold transition-colors flex items-center gap-1">
